...
- [x] `xe git add <file>` (add specific file)
- [x] `xe git add <file1> <file2>` (add multiple files)
- [x] `xe git push` (push to current branch, auto-detect)
- [x] `xe g push` (alias for git push)
- [x] `xe git push <branch>` (push to specific branch on origin)
- [x] `xe git push <remote> <branch>` (push to specific remote and branch)
- [x] `xe git push -u` (push and set upstream)
- [x] `xe git push --set-upstream` (push and set upstream)
